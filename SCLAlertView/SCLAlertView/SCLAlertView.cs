namespace Service.Bit.Client.iOS
{
    ...
    public class SCLAlertView : UIViewController
    {
        ...
        public SCLAlertView(string nibNameOrNil, NSBundle bundle, SCLAppearance appearance) : base(nibNameOrNil, bundle)
        {
            this.appearance = appearance;
            this.Setup();
        }

        public SCLAlertView(string nibNameOrNil, NSBundle bundle) : this(nibNameOrNil, bundle, new SCLAppearance())
        {

        }

        public SCLAlertView() : this(new SCLAppearance())
        {
        ...
        public SCLAlertViewResponder ShowCustom(string title,
                                                ...
                                                SCLAlertViewStyle style = SCLAlertViewStyle.Success,
        ...
        public SCLAlertViewResponder ShowAlert(SCLAlertViewStyle style,
                                               string title,
                                               string subTitle,
                                               string closeButtonTitle = null,
                                               double duration = 0.0,
                                               ...
                                               SCLAnimationStyle animationStyle = SCLAnimationStyle.TopToBottom)
        {
            ...
            // Spinner / icon
            if (style == SCLAlertViewStyle.Wait)
            {
        ...
        private static UIColor GetDefaultColorTextButton(SCLAlertViewStyle style)
        {
            switch (style)
            {
                case SCLAlertViewStyle.Success:
        ...
        private static UIColor GetDefaultColorStyle(SCLAlertViewStyle style)
        {
            switch (style)
            {
                case SCLAlertViewStyle.Success:
    ...
    public class SCLAlertViewResponder
    {
        ...
        protected SCLAlertView Alertview { get; }
